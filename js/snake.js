$(document).ready(function(){
	...
	$(document).keydown(function(e){
		...
		/*
		 *
-keydown  keyCode=87  (W)   which=87  (W)   charCode=0        
keypress keyCode=119 (w)   which=119 (w)   charCode=119 (w)  
keyup    keyCode=87  (W)   which=87  (W)   charCode=0        
...
keypress keyCode=115 (s)   which=115 (s)   charCode=115 (s)  
...
keyup    keyCode=68  (D)   which=68  (D)   charCode=0   
		...
		*/
		...
		else if(key == "83" && d != "down") d = "up";
		else if(key == "65" && d != "left") d = "right";
		else if(key == "87" && d != "up") d = "down";
