(function(){function C()
{
	...
	var p = canvas.scrollWidth;
	var f = canvas.scrollHeight;*/
	...
	u=q;
	v=r;
	for(var d=0.86*f,l=0.125*f,m=0.5*f,t=Math.random,n=Math.abs,o=z;
	o--;
	...
	e.arc(i,j,c,0,D,!0);
	e.closePath();
	e.fill()}}function E(d){d=d?d:window.event;
	...
	window.onload=function()
	{
		try{
			...
			//if(lng=="ru"||lng=="uk"||lng=="be")document.getElementById("flw").innerHTML=': <a href="http://www.twitter.com/spielzeugz" target="_blank">Twitter</a> / <a href="http://plus.google.com/116743952899287181520" target="_blank">G+</a> / <a href="http://vk.com/id266298870">VK</a>';
	}catch(e){}
	o=document.getElementById("mainCanvas");
	if(o.getContext){m=document.getElementById("outer");
